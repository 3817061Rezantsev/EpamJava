...
public class OptionalTask2 {
	public static int findSumOfNumbersBetweentwoPositiveNumbers(int[] a) {
		int f = -1, s = 0;
	...
	public static int[][] findMaxElementInMatrixAndRemoveAllRowsAndColumnsFromMatrixThatContainIt(int a[][], int M) {
		int max = -M;
		int n = a[0].length;
		int[][] d = a;
		int m = 0, l = 0;
	...
	public static int largestNumberOfIncreasingMatrixElementsInARow(int[] a) {
		int count = 1, max = 1;
	...
	public static void main(String[] args) throws NumberFormatException, IOException {
		...
		System.out.println(largestNumberOfIncreasingMatrixElementsInARow(B));
